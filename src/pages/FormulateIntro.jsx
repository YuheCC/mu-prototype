    ...
    <div className="formulate-intro-page">
      ...
      <section className="fi-section">
        <p className="fi-text">
          ...
          the MU Agent portal containing any known or unknown molecules, and within days will receive quantitative predictions of key
        ...
        <div className="fi-flow">
          <div className="fi-flow-card">
            ...
            <div className="fi-flow-sub">Submitted in MU Agent user portal</div>
          </div>
