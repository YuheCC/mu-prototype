...
// Demo chart data: Capacity Retention % vs Cycle ID (0–3500). Used: 0–200, Predicted: 200–3114, 80% line.
  ...
  if (!task) {
    return (
      <div className="pred-detail-page">
        <p>Task not found.</p>
        <button type="button" onClick={() => navigate('/tasks-data')}>Back to List</button>
      </div>
    )
  }
