...
const GROUPS = [
  ...
  },
  {
    ...
    icon: '🔗',
    tools: [
      { name: 'ERP', desc: 'Integrate MU Agent workflows with your ERP system', added: false },
      { name: 'LIMS', desc: 'Connect laboratory data from LIMS into MU Agent', added: false },
    ],
  },
]
      ...
      <header className="page-header page-header-with-back">
        <div>
          ...
          <p className="page-subtitle">
            View all tools in MU Agent, organized by Formulate, Design, Predict, and Manufacture.
          </p>
        </div>
